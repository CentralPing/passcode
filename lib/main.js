 ...
 * @param {Date} [payload.jti] JWT ID (defaults to a uuid.v4 value).
 * @param {Object} claims
 * @param {String} [claims.secret] A string to sign the JWT.
 * @param {String} [claims.code] The challenge code (defaults to random
 *  6 digit string).
...
function issue(
  ...
  } = {},
  {
    ...
    algorithm = (secret === undefined ? 'none' : 'HS256'),
    ...claims
  } = {},
  {
    salt,
